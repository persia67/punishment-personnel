    ...
    <div className="fixed inset-0 bg-white md:bg-black/50 md:backdrop-blur-sm flex items-center justify-center z-50 md:p-4 animate-in fade-in duration-200">
      <div className="bg-white md:rounded-2xl shadow-none md:shadow-2xl w-full md:max-w-3xl flex flex-col h-full md:h-auto md:max-h-[90vh] border-t-0 md:border-t-4 border-emerald-500">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 border border-emerald-100 bg-emerald-50/20 p-4 rounded-2xl">
            {/* Smart Search Field */}
            <div className="md:col-span-2 relative">
              <label className="block text-xs md:text-sm font-bold text-gray-755 mb-1.5 flex items-center gap-1">
                  ...
                  {matchedEmployees.length === 0 ? (
                    ...
                    matchedEmployees.map(emp => (
                      <button
                        ...
                        className="w-full text-right px-4 py-2.5 hover:bg-emerald-50/50 transition-colors flex items-center justify-between text-xs md:text-sm"
                      >
            ...
            <div className="flex flex-col">
              ...
              {formData.department === 'سایر (ورود دستی)' && (
                <input
                  ...
                  className="mt-1.5 w-full px-3 py-2.5 text-base md:text-sm border border-red-300 rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none"
                />
              )}
            </div>
            <div>
